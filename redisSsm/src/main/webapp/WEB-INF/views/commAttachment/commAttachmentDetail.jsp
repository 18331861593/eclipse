...
<html>
  <head>
	...
	<style type="text/css">
		.partition{ width:1000px;height:25px;}
			...
			$("#dg_project").datagrid({
				...
				columns:[[ 
				          {field:"id2",checkbox:true },
						   ...
						   {field:"fileUrl", title:"fileUrl", width:100},
						   
						   {field:"createdAt", title:"createdAt", width:100},
						   
						   {field:"fileType", title:"fileType", width:100},
