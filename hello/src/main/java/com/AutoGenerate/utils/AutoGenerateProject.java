...
public class AutoGenerateProject {
	...
	private static Class[] entityClasses = new Class[]{CommAttachment.class,Role.class,Menu.class,User.class};
//	private static Class[] entityClasses = new Class[]{Menu.class};
	
	private static Class userClazz = CommAttachment.class; 
	...
	public static void main(String[] args) {
		...
		generateDao("AutoGenerate");
		generateService("AutoGenerate");
		generateController("AutoGenerate");
		generateMapper("AutoGenerate");
